# This file is copied from https://bitbucket.org/kmike/django-widget-tweaks/
# Unfortunately django was not satisfied with just importing it, therefore it is hard copied here.
# Please be aware that updates will have to be included manually by pasting it here, unless you can find a workaround.
