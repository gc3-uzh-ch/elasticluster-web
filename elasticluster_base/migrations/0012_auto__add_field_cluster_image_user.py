...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cluster.image_user'
        db.add_column(u'elasticluster_base_cluster', 'image_user',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cluster.image_user'
        db.delete_column(u'elasticluster_base_cluster', 'image_user')
