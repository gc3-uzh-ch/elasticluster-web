...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClusterNode'
        db.create_table(u'elasticluster_base_clusternode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cluster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elasticluster_base.Cluster'])),
            ('node_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['elasticluster_base.ClusterNodeGroup'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'elasticluster_base', ['ClusterNode'])


    def backwards(self, orm):
        # Deleting model 'ClusterNode'
        db.delete_table(u'elasticluster_base_clusternode')
