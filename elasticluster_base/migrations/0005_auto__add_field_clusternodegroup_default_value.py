...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClusterNodeGroup.default_value'
        db.add_column(u'elasticluster_base_clusternodegroup', 'default_value',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClusterNodeGroup.default_value'
        db.delete_column(u'elasticluster_base_clusternodegroup', 'default_value')
