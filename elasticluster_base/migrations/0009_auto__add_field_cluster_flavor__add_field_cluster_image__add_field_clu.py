...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cluster.flavor'
        db.add_column(u'elasticluster_base_cluster', 'flavor',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)

        # Adding field 'Cluster.image'
        db.add_column(u'elasticluster_base_cluster', 'image',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)

        # Adding field 'Cluster.security_group'
        db.add_column(u'elasticluster_base_cluster', 'security_group',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cluster.flavor'
        db.delete_column(u'elasticluster_base_cluster', 'flavor')

        # Deleting field 'Cluster.image'
        db.delete_column(u'elasticluster_base_cluster', 'image')

        # Deleting field 'Cluster.security_group'
        db.delete_column(u'elasticluster_base_cluster', 'security_group')
