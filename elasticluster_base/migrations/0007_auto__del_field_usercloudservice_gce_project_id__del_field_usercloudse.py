...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserCloudService.gce_project_id'
        db.delete_column(u'elasticluster_base_usercloudservice', 'gce_project_id')

        # Deleting field 'UserCloudService.gce_client_id'
        db.delete_column(u'elasticluster_base_usercloudservice', 'gce_client_id')

        # Deleting field 'UserCloudService.gce_client_secret'
        db.delete_column(u'elasticluster_base_usercloudservice', 'gce_client_secret')


    def backwards(self, orm):
        # Adding field 'UserCloudService.gce_project_id'
        db.add_column(u'elasticluster_base_usercloudservice', 'gce_project_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=300),
                      keep_default=False)

        # Adding field 'UserCloudService.gce_client_id'
        db.add_column(u'elasticluster_base_usercloudservice', 'gce_client_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)

        # Adding field 'UserCloudService.gce_client_secret'
        db.add_column(u'elasticluster_base_usercloudservice', 'gce_client_secret',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)
