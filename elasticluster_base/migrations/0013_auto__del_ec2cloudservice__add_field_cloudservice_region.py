...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CloudService.region'
        db.add_column(u'elasticluster_base_cloudservice', 'region',
                      self.gf('django.db.models.fields.CharField')(default='nova', max_length=150),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CloudService.region'
        db.delete_column(u'elasticluster_base_cloudservice', 'region')
    ...
    models = {
        ...
        u'elasticluster_base.cluster': {
            ...
            'image_user': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
