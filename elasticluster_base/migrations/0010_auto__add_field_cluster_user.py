...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cluster.user'
        db.add_column(u'elasticluster_base_cluster', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cluster.user'
        db.delete_column(u'elasticluster_base_cluster', 'user_id')
