...
SECRET_KEY = 'p4edb3^hxlcj5n5$nrh0gr96egv=bvypmt3#99m#tv%ybd8bk+'
...
WSGI_APPLICATION = 'elasticluster_web.wsgi.application'
...
# As well production and staging can be different.
HOSTNAME = socket.gethostname().lower().split('.')[0].replace('-','')
try:
    exec "from elasticluster_web.hosts.host_%s import *" % HOSTNAME
except ImportError:
    pass
